...
tests_json = """{
  ...
  "amdd": {
     "Part1": {
       "./riscv -d ./code/input/amdd.input > ./code/out/amdd.solution": 0,
       "python3 compare.py ./code/out/amdd.solution ./code/ref/amdd.solution": 15
     },
     "Part2": {
       "timeout 60 ./riscv -r ./code/input/amdd.input > ./code/out/amdd.trace": 0,
       "python3 compare.py ./code/out/amdd.trace ./code/ref/amdd.trace": 45
     }
   },
  "All": {
    "Part1": {
